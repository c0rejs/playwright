    ...
    traps.forEach( trap => {
        newHandler[ trap ] = function () {
            try {
                ...
                if ( !e || !e.stack || !e.stack.includes( "at " ) ) {
                    throw e;
                }
                ...
                const stripWithBlacklist = ( stack, stripFirstLine = true ) => {
                    ...
                    return (
                        e.stack
                            ...
                            .filter( line => blacklist.every( bl => !line.trim().startsWith( bl ) ) )
                            .join( "\n" )
                    );
                };
                ...
                e.stack = e.stack.replace( "at Object.toString (", "at Function.toString (" );
                if ( ( e.stack || "" ).includes( "at Function.toString (" ) ) {
                    e.stack = stripWithBlacklist( e.stack, false );
                    throw e;
                }

                // Try using the anchor method, fallback to blacklist if necessary
                e.stack = stripWithAnchor( e.stack ) || stripWithBlacklist( e.stack );

                throw e; // Re-throw our now sanitized error
            }
        };
    } );
    return newHandler;
 ...
 */
utils.makeNativeString = ( name = "" ) => utils.cache.nativeToStringStr.replace( "toString", name || "" );
 ...
 * @param {object} obj
 */
utils.patchToStringNested = ( obj = {} ) => utils.execRecursively( obj, [ "function" ], utils.patchToString );
